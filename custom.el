...
(custom-set-faces
 ...
 '(tabbar-default ((t (:inherit variable-pitch :background "gray90" :foreground "gray50" :height 0.9))))
 '(tabbar-highlight ((t (:underline t))))
 '(tabbar-selected ((t (:inherit tabbar-default :background "#2e3436" :foreground "#b4fa70" :box (:line-width 4 :color "#2e3436") :weight bold))))
 '(tabbar-separator ((t (:inherit tabbar-default))))
 '(tabbar-unselected ((t (:inherit tabbar-default :box (:line-width 4 :color "grey90")))))

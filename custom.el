...
(custom-set-variables
 ...
 '(package-selected-packages
   '(jsonrpc noccur vundo gptel company-box editorconfig fancy-compilation vlf session project python-isort project-mode-line-tag ibuffer-project dap-mode ftable rust-mode lsp-ui company-lsp xcscope flycheck-lilypond verilog-mode csharp-mode docker-compose-mode dockerfile-mode goto-char-preview isearch-project rmsbolt dynamic-spaces ialign winnow auto-minor-mode json-navigator groovy-mode 0xc digit-groups fullframe kurecolor adaptive-wrap easy-repeat shell-pop disaster highlight-parentheses which-key nasm-mode x86-lookup pdf-tools unicode-troll-stopper toggle-quotes jinja2-mode change-inner toml-mode protobuf-mode flycheck-rust idomenu highlight-indentation web-mode company pos-tip realgud paradox discover yaml-mode wgrep volatile-highlights smex rainbow-mode pretty-mode powerline page-break-lines lua-mode keywiz js2-mode ido-ubiquitous highlight-escape-sequences highlight haskell-mode guru-mode goto-chg github-browse-file git-timemachine git-messenger full-ack flx-ido fastnav fancy-narrow expand-region easy-kill diminish diff-hl d-mode cython-mode company-quickhelp c-eldoc browse-kill-ring bm auctex anzu ag ack-and-a-half ace-window multiple-cursors winpoint try tagedit popwin ace-jump-mode))
...
(custom-set-faces
 ...
 '(lsp-face-highlight-write ((t (:weight bold))))
 ...
 '(lsp-modeline-code-actions-face ((t (:family "Fira Sans" :inherit homoglyph))))
 ...
 '(treemacs-directory-face ((t (:inherit (font-lock-function-name-face variable-pitch)))))
 '(treemacs-file-face ((t (:inherit variable-pitch))))
 '(treemacs-git-conflict-face ((t (:inherit (error variable-pitch)))))
 '(treemacs-git-ignored-face ((t (:inherit (font-lock-comment-face variable-pitch)))))
 '(treemacs-git-modified-face ((t (:inherit (font-lock-variable-name-face variable-pitch)))))
 '(treemacs-git-renamed-face ((t (:inherit (font-lock-doc-face variable-pitch)))))
 '(treemacs-git-untracked-face ((t (:inherit (font-lock-string-face variable-pitch)))))
 '(treemacs-root-face ((t (:inherit (font-lock-constant-face variable-pitch) :underline t :weight bold :height 1.2))))
 '(treemacs-tags-face ((t (:inherit (font-lock-builtin-face variable-pitch)))))
 '(variable-pitch ((t (:inherit default :weight normal :family "Fira Sans"))))

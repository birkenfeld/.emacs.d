...
(custom-set-variables
 ...
 '(LaTeX-mode-hook
   '(preview-mode-setup LaTeX-install-toolbar turn-on-reftex LaTeX-math-mode
                        auto-fill-mode))
 ...
 '(TeX-command-list
   '(("LaTeX" "%`%l%(mode)%' %t" TeX-run-TeX nil (latex-mode doctex-mode) :help
     ...
     ("Latexmk" "latexmk -latexoption=\"--interaction=nonstopmode\" -pdf %t"
 ...
 '(c-default-style
   '((java-mode . "java") (awk-mode . "awk") (other . "python")))
 ...
 '(grep-files-aliases
   '(("asm" . "*.[sS]") ("c" . "*.c") ("cc" . "*.cc") ("ch" . "*.[ch]")
     ("el" . "*.el") ("h" . "*.h") ("l" . "[Cc]hange[Ll]og*")
 ...
 '(haskell-indent-after-keywords
   '(("where" 2 0) ("of" 2) ("do" 2) ("in" 2 0) ("{" 2) ("if" 2) "then" "else"
     "let"))

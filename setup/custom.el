...
")
 ...
 '(package-selected-packages
   '(undo-tree project python-isort project-mode-line-tag ibuffer-project dap-mode ftable rust-mode lsp-ui company-lsp lsp-mode xcscope rust-auto-use flycheck-lilypond verilog-mode csharp-mode docker-compose-mode dockerfile-mode goto-char-preview isearch-project rmsbolt dynamic-spaces ialign winnow auto-minor-mode json-navigator groovy-mode 0xc f digit-groups plur fullframe kurecolor adaptive-wrap easy-repeat shell-pop autopair disaster fill-column-indicator highlight-parentheses which-key zeal-at-point nasm-mode x86-lookup pdf-tools unicode-troll-stopper toggle-quotes jinja2-mode change-inner toml-mode protobuf-mode flycheck-rust idomenu highlight-indentation web-mode company pos-tip irony realgud paradox discover yaml-mode wgrep volatile-highlights vlf virtualenv smooth-scrolling smex session rainbow-mode pretty-mode powerline page-break-lines nose markdown-mode magit-gh-pulls lua-mode keywiz js2-mode ido-ubiquitous highlight-symbol highlight-escape-sequences highlight hideshowvis haskell-mode guru-mode goto-chg github-browse-file git-timemachine git-messenger full-ack flycheck-irony flx-ido fastnav fancy-narrow expand-region easy-kill diminish diff-hl d-mode cython-mode company-quickhelp company-irony c-eldoc browse-kill-ring bm auctex anzu ag ack-and-a-half ace-window multiple-cursors winpoint try tagedit popwin ace-jump-mode))

...
(custom-theme-set-faces
 ...
 '(ecb-default-general-face ((t (:inherit variable-pitch :height 100))))
 '(ecb-default-highlight-face ((t (:inherit ecb-default-general-face :background "cornflower blue" :foreground "yellow"))))
 '(ecb-tag-header-face ((t (:background "SeaGreen1"))))
 '(ecb-tree-highlight-face ((t (:inherit (ecb-default-general-face highlight) :height 1.0))))

...
(let ((xwin '((class color) (min-colors 89) (type x)))
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-constant-face ((,xwin (:foreground ,plum-0 :weight normal))))
   `(font-lock-doc-face ((,xwin (:foreground ,plum-0))))
   `(font-lock-function-name-face ((,xwin (:foreground ,butter-1 :weight bold))))
   `(font-lock-keyword-face ((,xwin (:foreground ,cham-0 :weight normal))))
   `(font-lock-string-face ((,xwin (:foreground ,choc-1))
                            (,term (:foreground ,red-3))))
   `(font-lock-type-face ((,xwin (:foreground ,blue-0 :weight normal))))
   ...
   `(company-box-scrollbar ((t (:background ,alum-4))))
   `(company-tooltip ((t (:background ,alum-5))))
   `(company-tooltip-annotation ((,xwin (:inherit company-tooltip :foreground ,butter-2))))
   `(company-tooltip-selection ((,xwin (:inherit company-tooltip :background ,orange-3))))
